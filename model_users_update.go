...
// GetMarketingOptOut returns the MarketingOptOut field value if set, zero value otherwise.
func (o *UsersUpdate) GetMarketingOptOut() bool {
	if o == nil || IsNil(o.MarketingOptOut) {
		var ret bool
		return ret
	}
	return *o.MarketingOptOut
}

// GetMarketingOptOutOk returns a tuple with the MarketingOptOut field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UsersUpdate) GetMarketingOptOutOk() (*bool, bool) {
	if o == nil || IsNil(o.MarketingOptOut) {
		return nil, false
	}
	return o.MarketingOptOut, true
}
...
// SetMarketingOptOut gets a reference to the given bool and assigns it to the MarketingOptOut field.
...
func (o UsersUpdate) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MarketingOptOut) {
		toSerialize["marketing_opt_out"] = o.MarketingOptOut
	}
