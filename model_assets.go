...
// Assets A published analytics asset — a calculation or visualization built on a data connection
type Assets struct {
	// Optional.
...
// GetRequireCustomization returns the RequireCustomization field value
...
// GetRequireCustomizationOk returns a tuple with the RequireCustomization field value
// and a boolean to check if the value has been set.
