...
// Users An individual user account within a company
type Users struct {
	// Optional.
...
// GetMarketingOptOut returns the MarketingOptOut field value
...
// GetMarketingOptOutOk returns a tuple with the MarketingOptOut field value
// and a boolean to check if the value has been set.
...
// SetMarketingOptOut sets field value
