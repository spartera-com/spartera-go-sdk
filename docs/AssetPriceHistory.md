...
**AphId** | Pointer to **string** | Unique identifier. | [optional] 
...
`func NewAssetPriceHistory() *AssetPriceHistory`
...
`func (o *AssetPriceHistory) HasAssetId() bool`

HasAssetId returns a boolean if a field has been set.

### GetEndpointId

`func (o *AssetPriceHistory) GetEndpointId() string`

GetEndpointId returns the EndpointId field if non-nil, zero value otherwise.

### GetEndpointIdOk

`func (o *AssetPriceHistory) GetEndpointIdOk() (*string, bool)`
...
`func (o *AssetPriceHistory) SetEndpointId(v string)`

SetEndpointId sets EndpointId field to given value.

### HasEndpointId

`func (o *AssetPriceHistory) HasEndpointId() bool`
