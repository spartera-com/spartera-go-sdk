...
`func (o *AssetsInput) GetTopQuestions() string`

GetTopQuestions returns the TopQuestions field if non-nil, zero value otherwise.

### GetTopQuestionsOk

`func (o *AssetsInput) GetTopQuestionsOk() (*string, bool)`
...
`func (o *AssetsInput) SetTopQuestions(v string)`

SetTopQuestions sets TopQuestions field to given value.

### HasTopQuestions

`func (o *AssetsInput) HasTopQuestions() bool`
...
`func (o *AssetsInput) GetVizSpec() map[string]interface{}`

GetVizSpec returns the VizSpec field if non-nil, zero value otherwise.

### GetVizSpecOk

`func (o *AssetsInput) GetVizSpecOk() (*map[string]interface{}, bool)`
...
`func (o *AssetsInput) SetVizSpec(v map[string]interface{})`

SetVizSpec sets VizSpec field to given value.

### HasVizSpec

`func (o *AssetsInput) HasVizSpec() bool`
...
`func (o *AssetsInput) SetDateCollectionStart(v time.Time)`

SetDateCollectionStart sets DateCollectionStart field to given value.

### HasDateCollectionStart

`func (o *AssetsInput) HasDateCollectionStart() bool`
