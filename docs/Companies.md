...
**CompanyId** | Pointer to **string** | Unique identifier. | [optional] 
...
`func (o *Companies) SetPartnershipType(v string)`

SetPartnershipType sets PartnershipType field to given value.

### HasPartnershipType

`func (o *Companies) HasPartnershipType() bool`
