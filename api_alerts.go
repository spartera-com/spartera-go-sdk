...
/*
CompaniesCompanyIdUsersUserIdAlertsAssetAssetIdAllGet Get all alerts for a specific asset (from all users)     This would typically be restricted to asset owners or admins
...
/*
CompaniesCompanyIdUsersUserIdAlertsAssetAssetIdGet Get all alerts for a specific asset by the specified user     Useful for checking if user already has an alert set up for an asset
